            ...
            <div className='project-container'>
                ...
                <div className='container-content'>
                    ...
                    <div className='Project-desc'>
                        <p>An e-commerce project in which the admin may manage products and 
                            consumers can login/register and buy products. - MySQL, PHP, 
                            Javascript, HTML, CSS, and Bootstrap.</p>
                    </div>
                    ...
                    <a href="https://github.com/jainex17" aria-label="GitHub Link" rel="noopener noreferrer" target="_blank">
